...
export { parse, parseLine, joinProgram, joinProgramLines, splitProgram, needsMoreInput, continuesPrevious, defaultFixity } from './parse.js';
...
export const BML_VERSION = '0.43.0';
